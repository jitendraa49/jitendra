...
<div class="maincontent noright">
        	<div class="maincontentinner">
                ...
                <div class="content">
                <?php echo $this->Form->create('Category',array('url'=>array('controller'=>'category','action'=>'edit'),'type'=>'file','inputDefaults'=>array('div'=>false,'label'=>false),'class'=>'stdform')); ?>
			 ...
			 <p>
                ...
                <img src="<?php echo SITE_URL; ?>/images/banner/<?php echo $this->request->data['category']['image']; ?>" height="100px" width="100px">
                </p>
