...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo SITE_URL; ?>fonts/ionicons/css/ionicons.min.css">
    <link rel="stylesheet" href="<?php echo SITE_URL; ?>fonts/fontawesome/css/font-awesome.min.css">
