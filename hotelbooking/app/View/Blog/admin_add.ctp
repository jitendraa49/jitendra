...
<div class="maincontent noright">
        	<div class="maincontentinner">
                ...
                <div class="content">
                <?php echo $this->Form->create('Blog',array('url'=>array('controller'=>'blog','action'=>'add'),'type'=>'file','inputDefaults'=>array('div'=>false,'label'=>false),'class'=>'stdform')); ?>
			 ...
			 <p>
                ...
                <label>Date</label>
                <span class="field">
                <?php echo $this->Form->input('date', array('class' => 'longinput','style'=>"margin: 6px 7px 9px 0; width: 30%;",'type'=>'text')); ?></span>
