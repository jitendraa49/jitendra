...
var MonthYearColor = "#2e2e2e"; //Font Color of Month and Year in Calendar header.
var WeekHeadColor = "#1e8ad2"; //var WeekHeadColor="#18861B";//Background Color in Week header.
var SundayColor = "#ddd"; //var SundayColor="#C0F64F";//Background color of Sunday.
var SaturdayColor = "#ddd"; //Background color of Saturday.
var WeekDayColor = "#f3f3f3"; //Background color of weekdays.
var FontColor = "#FFFFFF"; //color of font in Calendar day cell.
var TodayColor = "#fe9809"; //var TodayColor="#FFFF33";//Background color of today.
var SelDateColor = "#1e8ad2"; //var SelDateColor = "#8DD53C";//Backgrond color of selected date in textbox.
...
function RenderCssCal(bNewCal)
{
	...
	if (Cal.ShowTime === true)
	{
		...
		if (TimeMode === 12)
		{
			...
			vCalTime += "</td><td style='width: 58px;'>";
...
document.getElementById('datetimepicker1').value;
document.getElementById('datetimepicker2').value=document.getElementById('datetimepicker1').value;
}
